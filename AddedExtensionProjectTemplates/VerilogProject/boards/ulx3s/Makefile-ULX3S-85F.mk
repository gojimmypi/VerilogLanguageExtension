...
VDIRFB  := ./obj_dir
BUILD_DIR ?= build
ULX3S_BUILD_DIR := $(BUILD_DIR)/ulx3s-85k
...
$(ULX3S_CONFIG): $(ULX3S_JSON) $(ULX3S_LPF) | $(ULX3S_BUILD_DIR)
	nextpnr-ecp5 --85k --json $(ULX3S_JSON) --lpf $(ULX3S_LPF) --textcfg $(ULX3S_CONFIG)

$(ULX3S_JSON): top.v | $(ULX3S_BUILD_DIR)
	yosys -ql $(ULX3S_LOG) -p 'read_verilog top.v; synth_ecp5 -json $(ULX3S_JSON)'

prog: $(ULX3S_BIT)
	/mnt/c/workspace/fujprog/build/fujprog.exe $(ULX3S_BIT)
