...
namespace VerilogLanguage
{
    ...
    internal sealed class VerilogAsyncQuickInfoSource : IAsyncQuickInfoSource
    {
        ...
        private static readonly IDictionary<VerilogToken.VerilogTokenTypes, string> VerilogKeywordHoverText = new Dictionary<VerilogToken.VerilogTokenTypes, string>
        {
            ...
            [VerilogToken.VerilogTokenTypes.Verilog_casex] = "The casex reserved word is a type of case statement provided to allow handling of donâ€™t-care conditions in the case comparisons. Casex treats both high-impedance (x and z) values as donâ€™t-cares.",
            [VerilogToken.VerilogTokenTypes.Verilog_casez] = "The casez reserved word is a type of case statement provided to allow handling of donâ€™t-care conditions in the case comparisons. Casez treats high-impedance (z) values as donâ€™t-cares.",
            ...
            [VerilogToken.VerilogTokenTypes.Verilog_module] = "The module declaration is the only design unit in Verilog. It describes both a designâ€™s interface to other designs in the same environment, and its functional composition.",
